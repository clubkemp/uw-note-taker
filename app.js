...
//TODO: Reaplce with a read in function for each call?
//require in the json doc so we don't have to read it in constantly
...
app.delete('/api/notes/:id', (req,res) =>{
    ...
    updateDb(result)
    //send and update statement to finish the route handle
